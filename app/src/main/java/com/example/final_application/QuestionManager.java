...
public class QuestionManager {
    ...
    public static String question1[] = {
            ...
            "ข้อที่ 2: ข้อใดเป็นวิธีการประกาศตัวแปรที่สามารถเปลี่ยนแปลงค่าได้ในภายหลัง (mutable) ใน JavaScript (ES6 ขึ้นไป)?",
            ...
            "ข้อที่ 10: ตัวแปรที่ประกาศด้วยคำสั่งใดต่อไปนี้ จะมีค่าคงที่ ไม่สามารถเปลี่ยนแปลงค่าได้หลังจากกำหนดค่าเริ่มต้น (immutable) ใน JavaScript (ES6 ขึ้นไป)?",
    };
